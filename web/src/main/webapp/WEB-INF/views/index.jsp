...
<header>
	<section id="jumbotron">
		<div id="header">
			<img
				src="${pageContext.request.contextPath}/resources/img/header.png" />
		</div>
	</section>
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="intro-text">
					<span class="name">Seminarios de Titulación</span> <span
						class="skills">Seminarios - Requisitos - Pre-inscripción</span>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-sm-4 portfolio-item">
				<a href="#portfolioModal1" class="portfolio-link"
					...
					src="${pageContext.request.contextPath}/resources/img/titulacion.jpg"
		...
		<div class="row">
			...
			<div class="col-lg-8 col-lg-offset-2 text-center">
				<a href="#" class="btn btn-lg btn-outline"> <i
					class="fa fa-download"></i> Descargar Requisitos
				</a>
			</div>
		</div>
	</div>
